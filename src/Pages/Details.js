...
const Details = (props) => {
  const [details, setDetails] = useState([
    {
      "id": 1,
      "title": "Best and worst Hindi films of 2022 so far: RRR, Gangubai Kathiawadi, KGF 2, Gehraiyaan on the list",
      "Image": "https://images.indianexpress.com/2022/06/kgf-2-759.jpg",
      "category": "Bollywood",
      "description": "Bollywood in 2022 has so far remained highly dependent on either audience emotions, or pan-India titles. While the former impacted the theatrical performance of releases like The Kashmir Files, Samrat Prithviraj and Bhool Bhulaiyaa 2, the year has been dominated by Hindi dubbed versions of regional movies."
    },
    {
      "id": 51,
      "title": "Madhuri Dixit reflects on Bollywood journey: Today, actors can be completely consumed by a movie they're doing",
      "Image": "https://www.pinkvilla.com/imageresize/madhuri_dixit_on_bollywood_journey_main.jpg?width=752&format=webp&t=pvorg",
      "category": "bollywood",
      "description": "Madhuri Dixit ruled the charts and box office back in the day. The actress, on her return from the US, has successfully ventured into new projects which also included a Netflix web series titled The Fame Game this year. At the moment, she is working on her debut album, The Film Star. In a recent chat with Hindustan Times, the actress reflected on her Bollywood journey over the years." 
    ...
    {
      "id": 61,
      "title": "‘Meri Mamma kehti thi…’ memes from Aamir Khan’s Laal Singh Chaddha trends on social media",
      "Image": "https://media2.bollywoodhungama.in/wp-content/uploads/2022/06/refe.jpg",
      "category": "footer1",
      "description": "As soon as the intriguing trailer of Laal Singh Chaddha was released, it has been garnering immense love from the audience. Filled with factors to create rage, it took no time for the trailer to charm its audience. Now that brands are picking up the dialogue from the trailer for their creative representation, we can surely say it has taken the internet by storm."
    },
    ...
    {
      "id": 6,
      "title": "Jug Jugg Jeeyo Box Office Estimate Day 3: Sees another jump on Sunday; collects Rs. 15.30 crores",
      "Image": "https://stat2.bollywoodhungama.in/wp-content/uploads/2022/06/Jug-Jugg-Jeeyo-Box-Office-Estimate-Day-3-Sees-another-jump-on-Sunday-collects-Rs.-15.30-crores-2.jpg",
      "category": "Bollywood",
      "description": "The Varun Dhawan and Kiara Advani starrer Jug Jugg Jeeyo is showing a good trend at the box office. According to early estimates, the movie has collected in the range of Rs. 14.90 to 15.90 crores on the third day to take the opening weekend total to Rs. 37 crores. The film has shown near 65 percent growth from Friday to Sunday, and this has put it in a good position to record an encouraging trend on the weekdays."
    },
    {
      "id": 54,
      "title": "Jug Jugg Jeeyo Box Office Estimate Day 3: Sees another jump on Sunday; collects Rs. 15.30 crores",
  ...
  {
    "id": 56,
    "title": "MacBook Air, 13-inch MacBook Pro with M2 launched along with iOS 16 ",
    "Image": "https://techcrunch.com/wp-content/uploads/2018/05/gettyimages-915808896.jpeg?w=730&crop=1",
    "category": "mix",
    "description": "Apple’s Worldwide Developer Conference 2022 (WWDC)’s opening keynote is now over. The WWDC conference will continue till June 10. Apple has showcased iOS 16, which is getting a revamped Lock Screen with new features, improved dictation and updates for the Messages app. It also revealed watchOS 9 which comes with new activity features, improvements to workout and ability to track medications as well. There was also macOS Ventura, which comes with better multi-tasking. The new iPadOS 16 also comes with improved multi-tasking thanks to the Stage Manager feature also seen on macOS 13."
  },
  {
    "id": 52,
    "title": "MacBook Air, 13-inch MacBook Pro with M2 launched along with iOS 16 ",
  ...
  {
    "id": 45,
    "title": "Nutraceuticals And Its Impact on Health Care: Decoding the health imperative",
